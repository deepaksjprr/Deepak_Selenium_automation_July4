...
public class Constants {
	...
	public static String admin_program_page_product_unavailable_text = "//i[@uib-tooltip='Selected product is disabled, the program can not be activated with disabled products']";
