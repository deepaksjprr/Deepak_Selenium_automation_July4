...
//	public By add_program_button = By.xpath("//button[contains(.,'Add Program Product')]");
	public By add_program_button = By.cssSelector("button[data-button-action='program-details-add-product']");
	...
	public By add_users_confirm_button_ok = By.xpath("//button[contains(.,'Yes') or contains(.,'Ok') ]");
...
//	public By budget_qty = By.xpath("(//label[contains(text(), 'Budget Quantity')]/..//div//p)[$$product_count$$]");
	...
	public By remove_product_button = By.xpath("//button[contains(.,'Remove Product')]");
	...
	public void click_program_admin_tile() throws Exception {
		...
		System.out.println("now clicking on admin tile");
	...
	public void sflt_click_program_admin_tile() throws Exception 
	{
		...
		System.out.println("entered inside the sflt frame");
		//wait_min();
		click_program_admin_tile();
	}
	
//	public void click_program_admin_tile_light() throws Exception {
...
//	}
	...
	public void set_new_program(WebDriver driver, String program_name) throws Exception {
		...
		boolean remove_product_btn_visible = isElementVisible(driver, remove_product_button);
		//waittillinvisibility(driver, remove_product_button);
		if(remove_product_btn_visible==false)
		{
			clickElement(driver, add_program_button);
			System.out.println("clicked on remove product button twice successfully");
		}
	...
	public void set_user_budget(String user_budget) throws Exception
	{
		...
		Scroll_ByVisibleElement(driver, refresh_b);
	...
	{
		switchToFrame(driver);
		Scroll_ByVisibleElement(driver, program_header);
	...
	public void set_program_campaign(String product_count, String campaign_name) throws Exception {
		...
		driver.findElement(By.xpath(campaign_field_input.replace("$$product_count$$", product_count))).sendKeys(campaign_name);
		wait_min();
		driver.findElement(By.xpath("(//a[contains(@title, '" + campaign_name + "')])['" + product_count + "']")).click();
		driver.switchTo().defaultContent();
	}
	...
	public void set_campaign_member_status(String product_count, String campaign_member_status) throws Exception {
		...
		wait_min();
		driver.findElement(By.xpath("(//label[contains(text(),'Campaign Member Status')]/..//select//option[contains(text(), '"+ campaign_member_status + "')])['" + product_count + "']")).click();
		driver.switchTo().defaultContent();
	}
	...
	public void add_user_in_program(String product_count, String user_name) throws Exception {
		...
		waittillvisibility(driver, user_displayed);
	...
	public void verify_program_on_admin_page(WebDriver driver, String program_name) throws Exception {
		...
		driver.findElement(By.xpath("//input[@placeholder='Search Products']")).sendKeys(program_name);
